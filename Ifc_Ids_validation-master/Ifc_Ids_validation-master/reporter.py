...
class Json(Reporter):
    ...
    def report(self):
        ...
        self.results["percent_specifications_pass"] = (
            math.floor((total_specifications_pass / total_specifications) * 100) if total_specifications else "N/A" #TODO
        )
        ...
        self.results["percent_requirements_pass"] = (
            math.floor((total_requirements_pass / total_requirements) * 100) if total_requirements else "N/A" #TODO
        )
        ...
        self.results["percent_checks_pass"] = (
            math.floor((total_checks_pass / total_checks) * 100) if total_checks else "N/A" #TODO
        )
        return self.results
    ...
    def report_specification(self, specification):
        ...
        for requirement in specification.requirements:
            ...
            percent_pass = math.floor((total_pass / total_applicable) * 100) if total_applicable else "N/A" #TODO
        ...
        percent_applicable_pass = (
            math.floor((total_applicable_pass / total_applicable) * 100) if total_applicable else "N/A" #TODO
        )
        percent_checks_pass = math.floor((total_checks_pass / total_checks) * 100) if total_checks else "N/A" #TODO

        total_applicable_fail = total_applicable - total_applicable_pass,
        total_checks_fail = total_checks - total_checks_pass,
        null_elems = False if (len(specification.applicable_entities) == 0 and specification.status) else True
